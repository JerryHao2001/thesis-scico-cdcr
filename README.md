...
python train_signature_partition_qp.py --train_signatures_path data_tanl/scico_signatures_train_coref_v1.jsonl --val_signatures_path data_tanl/scico_signatures_dev_coref_v1.jsonl --output_dir ckpts/part_qp_v2/run3 --eval_module_path evaluate_signature_coref.py --bert_model allenai/scibert_scivocab_uncased --edge_init_bias -0.1  --qp_mu 0.8 --window 16 --semantic_k 0 --no_lexical_edges --pdhg_iters 50 --threshold 0.2 --epochs 20 --lr 2e-5 --head_lr 5e-4 --lambda_b3 0.3 --lambda_aux 0.2 --lambda_cal 0.2 --balance_edge_loss --amp;


python train_signature_partition_qp.py --train_signatures_path data_tanl/scico_signatures_train_coref_v1.jsonl --val_signatures_path data_tanl/scico_signatures_dev_coref_v1.jsonl --output_dir ckpts/part_qp_v2/run4 --eval_module_path evaluate_signature_coref.py --bert_model allenai/scibert_scivocab_uncased --edge_init_bias -0.1  --qp_mu 0.1 --window 16 --semantic_k 0 --no_lexical_edges --pdhg_iters 50 --threshold 0.5 --epochs 15 --lr 2e-5 --head_lr 5e-4 --lambda_b3 1.0 --lambda_aux 0.0 --lambda_cal 0.2 --balance_edge_loss --amp;

python train_signature_partition_qp.py --train_signatures_path data_tanl/scico_signatures_train_coref_v1.jsonl --val_signatures_path data_tanl/scico_signatures_dev_coref_v1.jsonl --output_dir ckpts/part_qp_v2/run5 --eval_module_path evaluate_signature_coref.py --bert_model allenai/scibert_scivocab_uncased --edge_init_bias -0.1  --qp_mu 0.5 --window 16 --semantic_k 0 --no_lexical_edges --pdhg_iters 50 --threshold 0.5 --epochs 30 --lr 2e-5 --head_lr 5e-4 --grad_accum_steps 2 --lambda_b3 0.5  --lambda_lea 0.5 --lambda_aux 0.1 --lambda_cal 0.1 --balance_edge_loss --amp;

python train_signature_partition_qp.py --train_signatures_path data_tanl/scico_signatures_train_coref_v1.jsonl --val_signatures_path data_tanl/scico_signatures_dev_coref_v1.jsonl --output_dir ckpts/part_qp_v2/run6 --eval_module_path evaluate_signature_coref.py --bert_model allenai/scibert_scivocab_uncased --edge_init_bias -0.1  --qp_mu 0.5 --window 16 --semantic_k 0 --no_lexical_edges --pdhg_iters 50 --threshold 0.25 --epochs 30 --lr 2e-5 --head_lr 5e-4 --grad_accum_steps 4 --lambda_b3 1.0  --lambda_lea 1.0 --lambda_aux 0.0 --lambda_cal 0.0 --balance_edge_loss --amp;

python train_signature_partition_qp.py --train_signatures_path data_tanl/scico_signatures_train_coref_v1.jsonl --val_signatures_path data_tanl/scico_signatures_dev_coref_v1.jsonl --output_dir ckpts/part_qp_v2/run7 --eval_module_path evaluate_signature_coref.py --bert_model allenai/scibert_scivocab_uncased --edge_init_bias -0.1  --qp_mu 0.5 --window 16 --semantic_k 0 --no_lexical_edges --pdhg_iters 50 --threshold 0.25 --epochs 30 --lr 2e-5 --head_lr 5e-4 --grad_accum_steps 4 --lambda_b3 1.0  --lambda_lea 1.0 --lambda_aux 0.0 --lambda_cal 0.0 --balance_edge_loss --amp;

python train_signature_partition_qp.py --train_signatures_path data_tanl/scico_signatures_train_coref_v1.jsonl --val_signatures_path data_tanl/scico_signatures_dev_coref_v1.jsonl --output_dir ckpts/part_qp_v2/run8 --eval_module_path evaluate_signature_coref.py --bert_model allenai/scibert_scivocab_uncased --edge_init_bias -0.1  --qp_mu 0.5 --window 16 --semantic_k 8 --no_lexical_edges --pdhg_iters 50 --threshold 0.25 --epochs 30 --lr 2e-5 --head_lr 5e-4 --grad_accum_steps 4 --lambda_b3 1.0  --lambda_lea 1.0 --lambda_aux 0.0 --lambda_cal 0.0 --balance_edge_loss --amp;

python train_signature_partition_qp.py --train_signatures_path data_tanl/scico_signatures_train_coref_v1.jsonl --val_signatures_path data_tanl/scico_signatures_dev_coref_v1.jsonl --output_dir ckpts/part_qp_v3/run3 --eval_module_path evaluate_signature_coref.py --bert_model allenai/scibert_scivocab_uncased --edge_init_bias -0.1  --qp_mu 0.5 --window 16 --semantic_k 0 --no_lexical_edges --pdhg_iters 80 --epochs 30 --lr 2e-5 --head_lr 5e-4 --grad_accum_steps 2 --lambda_b3 0.8 --lambda_lea 0.5 --lambda_ceaf 0.8 --lambda_aux 0.0 --lambda_cal 0.5 --node_proj mlp --balance_edge_loss --amp

#CoNLL=76.01
python train_signature_partition_qp.py --train_signatures_path data_tanl/scico_signatures_train_coref_v1.jsonl --val_signatures_path data_tanl/scico_signatures_dev_coref_v1.jsonl --output_dir ckpts/part_qp_v3/run4 --eval_module_path evaluate_signature_coref.py --bert_model allenai/scibert_scivocab_uncased --edge_init_bias -0.1  --qp_mu 0.5 --window 16 --semantic_k 0 --no_lexical_edges --pdhg_iters 30 --epochs 30 --lr 2e-5 --head_lr 5e-4 --grad_accum_steps 1 --lambda_b3 0.8 --lambda_lea 0.5 --lambda_ceaf 0.3 --lambda_aux 0.0 --lambda_cal 0.5 --node_proj none --balance_edge_loss --amp 


python train_signature_partition_qp.py --train_signatures_path data_tanl/scico_signatures_train_coref_v1.jsonl --val_signatures_path data_tanl/scico_signatures_dev_coref_v1.jsonl --output_dir ckpts/part_qp_v3/run5 --eval_module_path evaluate_signature_coref.py --bert_model allenai/scibert_scivocab_uncased --edge_init_bias -0.1  --qp_mu 0.5 --window 16 --semantic_k 0 --no_lexical_edges --pdhg_iters 30 --epochs 30 --lr 2e-5 --head_lr 5e-4 --grad_accum_steps 4 --lambda_b3 0.8 --lambda_lea 0.5 --lambda_ceaf 0.3 --lambda_aux 0.0 --lambda_cal 0.5 --node_proj none --balance_edge_loss --amp 
